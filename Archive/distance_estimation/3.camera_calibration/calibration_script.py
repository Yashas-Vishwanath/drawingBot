...
SQUARE_SIZE = 16  # millimeters (change it according to printed size)

# termination criteria
criteria = (cv.TERM_CRITERIA_EPS + cv.TERM_CRITERIA_MAX_ITER, 30, 0.001)


calib_data_path = "distance_estimation/calib_data"
...
image_dir_path = "distance_estimation/3.camera_calibration/images"
